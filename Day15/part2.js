...
function play(machine) {
    ...
    while (loops < 200000) {       
        ...
        switch (result) {
            ...
            case 'input':
                [direction] = getDirectionAuto(map, position, lastDirection);
            ...
            case 'output':
                ...
                switch(output) {
                    ...
                    case 2:
                        ...
                        map[position[1]][position[0]] = depth - 1;
                        position = [x, y];
                        map[y][x] = 'D';
                        lastDirection = direction;
                        steps++;
...
try {
    const map = play(machine);
    const maxDepth = findMaxDepth(machine, map);
